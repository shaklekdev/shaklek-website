...
export const catalog: CatalogItem[] = [
  ...
  },
  {
    ...
    image: "/catalog/wrap-set-ivory-front.png",
    backImage: "/catalog/wrap-set-ivory-back.png",
    colorImages: {
      Ivory: { front: "/catalog/wrap-set-ivory-front.png", back: "/catalog/wrap-set-ivory-back.png" },
      White: { front: "/catalog/wrap-set-white-front.png", back: "/catalog/wrap-set-white-back.png" },
      Navy: { front: "/catalog/wrap-set-navy-front.png", back: "/catalog/wrap-set-navy-back.png" },
      Burgundy: { front: "/catalog/wrap-set-burgundy-front.png", back: "/catalog/wrap-set-burgundy-back.png" },
    },
  },
  {
