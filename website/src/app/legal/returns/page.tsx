...
export default function ReturnsPage() {
  return (
    <LegalPage title="Returns, Alterations & Refunds" updated="8 August 2026">
      <p>
        Every Shaklek piece is made to order, for one person — it can&apos;t
        be restocked or resold. Because of that, our policy works
        differently from a standard retail return, and we&apos;d rather be
        upfront about exactly how, before you order.
      </p>
      ...
      <p>
        ...
        applies whether you used the free bucket size or the optional
        camera-measurement upgrade — the guarantee doesn&apos;t change,
        only how likely you are to need it.
      </p>
      ...
      <p>
        ...
        feasible for a tailor to build as described. If that happens, we&apos;ll
        come back to you to work out a version that is — at no extra
        charge. If we genuinely can&apos;t land on something that works for
        both you and the tailor, nothing is produced, and you get a full
        refund. That&apos;s the only case where a cash refund applies.
      </p>
