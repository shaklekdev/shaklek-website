...
- [ ] store-fitting-measurements | session | confirmed:2026-09-14 | The tailor's full measurement set has nowhere to live. Founder: "this is our MOST IMPORTANT DATA", she will share each appointment's numbers and they go in the database. Needs more fields than customers.measurements has today. Two journal claims about keeping them were cut until it exists
