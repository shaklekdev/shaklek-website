...
2. **Payment gateway** (`payment-auth-todo.md`) — checkout can't actually take money without this. Provider decided (Stripe); merchant account still blocked on incorporation.
